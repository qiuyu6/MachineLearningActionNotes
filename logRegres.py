...
def stocGradAscent1(dataMatrix, classLabels, numIter):
	...
	print 'Weight matrix is: ', float(weights[0]), float(weights[1]), float(weights[2])
	return weights 
...
def gradAscent(dataMatIn, classLabels):
	...
	for k in range(maxCycles):
		h = sigmoid(dataMatrix * weights) #Matrix multiplication, because of NumPy matrix
		error = labelMat - h
