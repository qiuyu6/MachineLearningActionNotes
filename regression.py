...
def main():
	...
	#print ws
	#plotLine(mat(xArr), mat(yArr), ws)
	#yHat = mat(xArr) * ws
	#corr = corrcoef(yHat.T, mat(yArr))
	#print corr
	...
	#yHat1 = lwlrTest(xArr[0:99],xArr[0:99],yArr[0:99],1.0)
	...
	#yHat1 = lwlrTest(xArr[100:199],xArr[0:99],yArr[0:99],1.0)
