...
def main():
	dataArr, lableArr = loadDataset('svmTestSet.txt')
	#b, alphas = smoSimple(dataArr, lableArr, 0.6, 0.001, 40)
	b, alphas = smoP(dataArr, lableArr, 0.6, 0.001, 40)
	ws = calcWs(alphas, dataArr, lableArr)
	dataMat = mat(dataArr)
	classLabel = dataMat[2] * mat(ws) + b
	print classLabel
	print lableArr[2]
	#print alphas[alphas > 0]
	#for i in range(100):
	#	if alphas[i] > 0.0:
	#		print dataArr[i], lableArr[i]
